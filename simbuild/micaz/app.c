...
#line 371
{
  ...
  if (tcp_pkt->ack_num == TransportP__socketArray[sim_node()][fd].ISN + 1) {
      ...
      for (i = 0; i < size; i++) {
          ...
          printf("%d, ", TransportP__socketArray[sim_node()][fd].rcvdBuff[TransportP__socketArray[sim_node()][fd].lastRcvd]);
